...
VERIFLOW is a framework for evaluating the reliability of AI-generated responses.
Large language models can produce answers that sound convincing but are factually incorrect,
contradictory, or unsupported. VERIFLOW analyzes responses from multiple perspectives and
combines the results into a final reliability score.

## Why I Built This

Modern LLM outputs often sound confident even when they are wrong. That makes hallucinations
difficult to detect, especially for users who do not already know the correct answer.
